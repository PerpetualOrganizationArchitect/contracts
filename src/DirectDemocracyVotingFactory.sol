...
contract DirectDemocracyVotingFactory {
    event VotingContractCreated(
        address indexed votingAddress, address indexed treasuryAddress, string POname, uint256 quorumPercentage
    );

    function createDirectDemocracyVoting(
        address _ddToken,
        ...
        DirectDemocracyVoting newVoting =
            new DirectDemocracyVoting(_ddToken, _nftMembership, _allowedRoleNames, _treasuryAddress, quorumPercentage);
